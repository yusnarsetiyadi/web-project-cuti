									...
									while($d = mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td>												
												<?php 
												// cuti diambil
												$xx = mysqli_query($koneksi,"select sum(jumlah_cuti) as total from cuti where jenis_cuti_id=$jenisid and user_id=$saya and year(tanggal_cuti)='$tahun' and manajer_status='Terima'");	
