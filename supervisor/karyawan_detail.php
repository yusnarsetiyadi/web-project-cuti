    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          ...
          <?php
          $idkaryawan = $_GET['id'];
          $data = mysqli_query($koneksi,"select divisi.divisi_name as divisi_nama, user.* from user join divisi on user.divisi_id = divisi.divisi_id where user.id=$idkaryawan");
            ...
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                if($d['foto']=="karyawan_foto.png"){
                  ...
                  ?>
                  <img class="profile-user-img img-fluid img-circle"
                  src="../gambar/user/<?php echo $d['_foto'] ?>"
                  alt="User profile picture">
                  <?php
                }
