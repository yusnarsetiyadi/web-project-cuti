...
<div class="content-wrapper">	
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Tambah Supervisor</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="index.php">Home</a></li>
						<li class="breadcrumb-item active">Tambah Data Supervisor</li>
					</ol>
				</div>
			</div>
		</div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Tambah Data Supervisor</h3>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
              	<form action="supervisor_act.php" method="POST" enctype="multipart/form-data">
