...
if ($status=="Terima"){
   $subject  = "Pengajuan Cuti Diterima Manajer";
   $statusLabel = "<span style='color:#28a745; font-weight:bold;'>DITERIMA ✅</span>";
   $extraInfo  = "<p>Sampai bertemu kembali. Draf pengajuan cuti dapat di download melalui website <a href='https://cutideltatekno.my.id' target='_blank' style='color:#007bff; text-decoration:none;'>cutideltatekno.my.id</a>.</p>";
}else{
   $subject  = "Pengajuan Cuti Ditolak Manajer";
   $statusLabel = "<span style='color:#dc3545; font-weight:bold;'>DITOLAK ❌</span>";
   $extraInfo  = "<p>Silakan hubungi manajer Anda untuk informasi lebih lanjut. Draf pengajuan cuti dapat di download melalui website <a href='https://cutideltatekno.my.id' target='_blank' style='color:#007bff; text-decoration:none;'>cutideltatekno.my.id</a>.</p>";
}
...
<div style='font-family: Arial, sans-serif; color:#333;'>
  ...
  <div style='border:1px solid #ddd; border-top:none; padding:20px; border-radius:0 0 8px 8px;'>
    ...
    <p>Pengajuan cuti Anda telah <b>$statusLabel</b> oleh manajer.</p>
    <table style='width:100%; border-collapse:collapse; margin:15px 0;'>
      <tr>
        <td style='padding:8px; border:1px solid #ddd; width:30%;'><b>Manajer</b></td>
        <td style='padding:8px; border:1px solid #ddd;'>$manajer</td>
      </tr>
      <tr>
